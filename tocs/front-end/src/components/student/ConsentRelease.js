...
const ConsentRelease = () => {
    ...
    const PDF = () => (
        <a href="http://www.to-cs.org/tocs/wp-content/uploads/TOCS-StudentsParentsHB-Reg.pdf" target="_blank" rel="noreferrer">Student and Parent Handbook.</a>
    );
    ...
    const studentNames = registrationPreferencesResponse && Object.values(registrationPreferencesResponse.students)
        ...
        <>
            ...
            <Card size="xlarge">
                <CardBody>
                    ...
                    <p>
                        I(we), the parent(s) of {studentNames} request that our child/children,
                        {studentNames}, be permitted to participate in all activities of the Thousand
                    ...
                    <p className="font-weight-bold">
                        By clicking on the "Agree and Continue" button below, I, {registrationPreferencesResponse && formatPersonNames(registrationPreferencesResponse.person)}, agree to
                        the legal terms outlined above, and I’ve also read and agreed to the <PDF />
                    </p>
