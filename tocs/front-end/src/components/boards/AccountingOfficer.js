  ...
  return (
    <Card size="medium" plain="true">
      <CardBody>
        ...
        {content.currentAndFutureSchoolYears &&
          content.currentAndFutureSchoolYears.map((schoolYear, sindex) => {
            return (
              <React.Fragment key={"schoolYear-" + sindex}>
                <div className="row">
                  <div className="col-md-12">
                    <DailyRegistrationSummary schoolYear={schoolYear} />
                  </div>
                  <div className="col-md-12">
                    <ChargesCollected schoolYear={schoolYear} />
                  </div>
                </div>
              </React.Fragment>
            );
