...
const SchoolYearForm = () => {
  ...
  const [earlyRegistrationTuition, setEarlyRegistrationTuition] =
    useState("380.0");
  const [tuition, setTuition] = useState("380.0");
  const [
    tuitionDiscountForThreeOrMoreChild,
    setTuitionDiscountForThreeOrMoreChild,
  ] = useState("38.0");
  const [tuitionDiscountForPreK, setTuitionDiscountForPreK] = useState("40.0");
  const [tuitionDiscountForInstructor, setTuitionDiscountForInstructor] =
    useState("0.0");
  const [pvaMembershipDue, setPvaMembershipDue] = useState("15.0");
  const [cccaMembershipDue, setCccaMembershipDue] = useState("20.0");
  const [earlyRegistrationStartDate, setEarlyRegistrationStartDate] =
    useState("");
  const [earlyRegistrationEndDate, setEarlyRegistrationEndDate] = useState("");
  const [registrationStartDate, setRegistrationStartDate] = useState("");
  const [registration75PercentDate, setRegistration75PercentDate] =
    useState("");
  ...
  const handleSave = (e) => {
    ...
    if (checkBtn.current.context._errors.length === 0) {
      const obj = {
        ...
        ageCutoffMonth,
        registrationFee,
        earlyRegistrationTuition,
        tuition,
        tuitionDiscountForThreeOrMoreChild,
        tuitionDiscountForPreK,
        tuitionDiscountForInstructor,
        pvaMembershipDue,
        cccaMembershipDue,
        earlyRegistrationStartDate,
        earlyRegistrationEndDate,
        registrationStartDate,
        registration75PercentDate,
        registrationEndDate,
        refund90PercentDate,
        refund50PercentDate,
        refundEndDate,
      };
      dispatch(id ? saveSchoolYear(id, obj) : addSchoolYear(obj))
        .then(() => {
          setSuccessful(true);
        })
        .catch(() => {
            ...
            {!successful && (
              <div>
                ...
                <div className="row">
                  ...
                  <div className="form-group col-md-4 mb-3">
                    <label htmlFor="earlyRegistrationTuition">
                ...
                <div className="row">
                  <div className="form-group col-md-4 mb-3">
                    <label htmlFor="tuitionDiscountForThreeOrMoreChild">
                      Tuition Discount
                      <br />
                      For 3 Or More Child
                    </label>
                  ...
                  <div className="form-group col-md-4 mb-3">
                    <label htmlFor="tuitionDiscountForPreK">
                      Tuition Discount
                      <br />
                      For Pre-K
                    </label>
                  ...
                  <div className="form-group col-md-4 mb-3">
                    <label htmlFor="tuitionDiscountForInstructor">
                      Tuition Discount
                      <br />
                      For Instructor
                    </label>
                ...
                <div className="row">
                  ...
                  <div className="form-group col-md-6 mb-3">
                    <label htmlFor="cccaMembershipDue">
                      CCCA Membership Due
                    </label>
                    <Input
                      type="text"
                ...
                <div className="row">
                  <div className="form-group col-md-6 mb-3">
                    <label htmlFor="earlyRegistrationStartDate">
                  ...
                  <div className="form-group col-md-6 mb-3">
                    <label htmlFor="earlyRegistrationEndDate">
                ...
                <div className="row">
                  ...
                  <div className="form-group col-md-4 mb-3">
                    <label htmlFor="registration75PercentDate">
                      Registration 75% Date
                    </label>
                    <Input
                      type="text"
                      className="form-control"
