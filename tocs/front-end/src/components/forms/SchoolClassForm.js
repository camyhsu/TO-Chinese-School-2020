...
import { addSchoolClass, saveSchoolClass, getSchoolClass } from '../../actions/registration.action';
...
const SchoolClassForm = ({ location: urlLocation } = {}) => {
    ...
    const handleSave = (e) => {
        ...
        if (checkBtn.current.context._errors.length === 0) {
            const obj = {
                englishName, chineseName, shortName, description, location, schoolClassType, maxSize, minAge, maxAge, gradeId
            };
            dispatch(id ? saveSchoolClass(id, obj) : addSchoolClass(obj)).then(() => {
                setSuccessful(true);
            }).catch(() => {
                setSuccessful(false);
            });
                    ...
                    <Form onSubmit={handleSave} ref={form}>
                        {!successful && (
                            <div>
                                ...
                                <div className="row">
                                    <div className="form-group col-md-6 mb-3">
                                        <label htmlFor="shortName">Short Name <OptionalField /></label>
                                        <Input
                                            type="text"
                                            className="form-control"
                                            name="shortName"
                                ...
                                <div className="row">
                                    <div className="form-group col-md-6 mb-3">
                                        <label htmlFor="location">Location <OptionalField /></label>
                                        <Input
                                            type="text"
                                            className="form-control"
                                            name="location"
                                    ...
                                    <div className="form-group col-md-6 mb-3">
                                        <label htmlFor="schoolClassType">Type <OptionalField /></label>
                                        <Select
                                            className="form-control"
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-md-6 mb-3">
                                        <label htmlFor="type">Grade <OptionalField /></label>
                                        <Select
                                            className="form-control"
                                            name="gradeId"
                                            value={gradeId}
                                            onChange={onChangeField}>
                                            <option value=''></option>
                                            {grades.map(g => (<option key={`g-${g.id}`} value={g.id}>{g.chineseName}</option>))}
                                        </Select>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="form-group col-md-6 mb-3">
                                        <label htmlFor="minAge">Min Age <OptionalField /></label>
                                        <Input
                                            type="text"
                                            className="form-control"
                                            name="minAge"
                                    ...
                                    <div className="form-group col-md-6 mb-3">
                                        <label htmlFor="maxAge">Max Age <OptionalField /></label>
                                        <Input
                                            type="text"
                                            className="form-control"
                                            name="maxAge"
