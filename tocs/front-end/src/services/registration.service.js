...
const getActiveSchoolClassesForCurrentNextSchoolYear = () => dataService.get('admin/school_classes/toggle_active');

const getSchoolClass = (schoolYearId) => dataService.get('admin/school_classes/edit/' + schoolYearId);

const saveSchoolClass = (schoolYearId, obj) => dataService.put('admin/school_classes/edit/' + schoolYearId, obj);

const addSchoolClass = (obj) => dataService.post('admin/school_classes/new', obj);

const toggleActiveSchoolClass = (id, schoolYearId, active) => dataService.put(`admin/school_classes/toggle_active/${id}?schoolYearId=${schoolYearId}&active=${active}`);

const getSchoolYears = () => dataService.get('admin/school_years/index');

const getSchoolYear = (schoolYearId) => dataService.get('admin/school_years/edit/' + schoolYearId);

const saveSchoolYear = (schoolYearId, obj) => dataService.put('admin/school_years/edit/' + schoolYearId, obj);

const addSchoolYear = (obj) => dataService.post('admin/school_years/new', obj);

const toggleAutoClassAssignment = (id) => dataService.put('admin/school_years/toggle_auto_class_assignment/' + id);

const getManageStaffAssignments = () => dataService.get('admin/staff_assignments/index');

const getManageStaffAssignment = (id) => dataService.get('admin/staff_assignments/show/' + id);
...
const getFamilyAddress = (familyId) => dataService.get(`registration/families/edit_address/${familyId}`);

const saveFamilyAddress = (familyId, obj) => dataService.put(`registration/families/edit_address/${familyId}`, obj);

const addParent = (familyId, obj) => dataService.post('registration/families/add_parent/' + familyId, obj);

const addChild = (familyId, obj) => dataService.post('registration/families/add_child/' + familyId, obj);
...
const getPersonalDetails = (personId, obj) => dataService.get('registration/people/edit/' + personId);

const savePersonalDetails = (personId, obj) => dataService.put('registration/people/edit/' + personId, obj);

const addPersonalAddress = (personId, obj) => dataService.post('registration/people/new_address/' + personId, obj);

const savePersonalAddress = (personId, obj) => dataService.put(`registration/people/edit_address/${personId}`, obj);

const getPersonalAddress = (personId) => dataService.get(`registration/people/edit_address/${personId}`);

const saveBookCharges = (schoolYearId, obj) => dataService.put(`admin/school_years/edit_book_charge/${schoolYearId}`, obj);

const getBookCharges = (schoolYearId) => dataService.get(`admin/school_years/edit_book_charge/${schoolYearId}`);

const getActiveSchoolClasses = (schoolYearId) => dataService.get(`registration/active_school_classes/index/${schoolYearId}`);
