        ...
        >
          <Switch>
            ...
            <Route
              ...
              component={SearchStudentsByRegistrationDates}
            />
            <Route
              exact
              path="/librarian/books/read-only"
              component={() => <Books readOnly={true} />}
            />
            <Route
              exact
              path="/accounting/in-person-registration-payments"
              component={InPersonRegistrationPayments}
            />
            <Route
              exact
              path="/accounting/instructor-discount"
              component={InstructorDiscount}
            />
            <Route
              exact
              path="/accounting/charges-collected"
              component={ChargesCollected}
            />
            <Route
              exact
              path="/accounting/daily-online-registration-summary"
              component={DailyRegistrationSummary}
            />
            <Route
              exact
            ...
            <Route
              exact
              path="/accounting/withdraw-request"
            ...
            <Route
              exact
              path="/admin/school-year-details"
              component={SchoolYearDetails}
            />
            <Route
              exact
              path="/admin/manage-staff-assignments"
              component={ManageStaffAssignments}
            />
            <Route
              exact
              path="/admin/manage-staff-assignment"
              component={ManageStaffAssignment}
            />
            <Route
              exact
            ...
            <Route
              exact
              path="/registration/active-school-classes"
              component={ActiveSchoolClasses}
            />
            <Route
              exact
              path="/registration/active_school_classes/grade_student_count"
              component={ActiveSchoolClassGradeCount}
            />
            <Route
              exact
              path="/registration/active_school_classes/grade_class_student_count"
              component={SchoolClassCount}
            />
            <Route
              exact
              path="/registration/instructor-assignment"
              component={InstructorAssignmentForm}
            />
            <Route
              exact
              path="/registration/student-class-assignments"
              component={ListActiveStudentsByName}
            />
            <Route exact path="/registration/family" component={Family} />
            <Route exact path="/registration/people" component={People} />
            <Route
              exact
              path="/registration/show-person"
              component={PersonDetails}
            />
            <Route
              exact
              path="/registration/sibling-in-same-grade"
              component={SiblingInSameGrade}
            />
            <Route
              exact
              path="/student/consent-release"
              component={ConsentRelease}
            />
            ...
            <Route
              ...
              component={ActiveSchoolClassesForInstructionOfficer}
            />
            <Route
              exact
              path="/instruction/school-classes"
              component={SchoolClassStudents}
            />
            ...
            <Route
              exact
              path="/accounting/manual-transaction"
