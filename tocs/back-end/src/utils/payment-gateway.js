      ...
      if (response != null) {
        if (
          ...
          if (response.getTransactionResponse().getMessages() != null) {
            ...
            rtn.authorizationCode = response
              .getTransactionResponse()
              .getAuthCode();
            rtn.responseCode = response
              .getTransactionResponse()
              .getResponseCode();
            rtn.messageCode = response
              .getTransactionResponse()
              .getMessages()
              .getMessage()[0]
              .getCode();
            rtn.description = response
              .getTransactionResponse()
              .getMessages()
              .getMessage()[0]
              .getDescription();
          } else if (response.getTransactionResponse().getErrors() != null) {
            rtn.errorCode = response
              .getTransactionResponse()
              .getErrors()
              .getError()[0]
              .getErrorCode();
            rtn.errorMessage = response
              .getTransactionResponse()
              .getErrors()
              .getError()[0]
              .getErrorText();
