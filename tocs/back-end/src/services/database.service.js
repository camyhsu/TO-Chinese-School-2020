...
const generateChangeLog = (diffTypes) =>
  runLiquibase("generateChangeLog", {
    changeLogFile: `${DIR}/dbchangelog-${Date.now()}.xml`,
    ...(diffTypes && { diffTypes }),
  });
const snapshot = () =>
  runLiquibase("snapshot", {
...
export { databaseName, generateChangeLog, snapshot, sync, update };
