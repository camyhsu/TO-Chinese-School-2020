...
export default (router) => {
  ...
  router.get("/admin/school_classes/index", [], controller.getSchoolClasses);
  ...
  router.get("/admin/school_classes/edit/:id", [], controller.getSchoolClass);

  router.put("/admin/school_classes/edit/:id", [], controller.saveSchoolClass);

  router.post("/admin/school_classes/new", [], controller.addSchoolClass);
  ...
  router.get("/admin/school_years/index", [], controller.getSchoolYears);

  router.get("/admin/school_years/edit/:id", [], controller.getSchoolYear);

  router.put("/admin/school_years/edit/:id", [], controller.saveSchoolYear);

  router.post("/admin/school_years/new", [], controller.addSchoolYear);
  ...
  router.post("/registration/families/new", [], controller.addFamily);

  router.get("/registration/families/show/:id", [], controller.getFamily);
  ...
  router.get("/registration/people/index", [], controller.getPeople);

  router.get("/registration/people/show/:id", [], controller.getPerson);

  router.get("/registration/people/edit/:id", [], studentController.getPerson);

  router.put("/registration/people/edit/:id", [], studentController.editPerson);
