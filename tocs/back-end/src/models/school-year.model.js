  ...
  const SchoolYear = sequelize.define(
    "school_year",
    {
      ...
      registration75PercentDate: {
        type: Sequelize.DATE,
        field: "registration_75_percent_date",
        allowNull: false,
      },
      registrationEndDate: {
        type: Sequelize.DATE,
      ...
      refund50PercentDate: {
        type: Sequelize.DATE,
        field: "refund_50_percent_date",
        allowNull: false,
      },
      refund90PercentDate: {
        type: Sequelize.DATE,
        field: "refund_90_percent_date",
      },
      refundEndDate: {
        type: Sequelize.DATE,
        field: "refund_end_date",
        allowNull: false,
      },

      earlyRegistrationStartDate: {
        type: Sequelize.DATE,
        field: "early_registration_start_date",
        allowNull: false,
      },
      earlyRegistrationEndDate: {
        type: Sequelize.DATE,
        field: "early_registration_end_date",
        allowNull: false,
      },

      ageCutoffMonth: {
        type: Sequelize.INTEGER,
        field: "age_cutoff_month",
        allowNull: false,
      },
