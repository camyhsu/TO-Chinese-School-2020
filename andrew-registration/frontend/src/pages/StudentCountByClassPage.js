...
export default class StudentCountByClassPage extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        const fetchData = async () => {
            try {
                ...
                const response = await fetch(`/directories/studentcount/class/${'14'}`);
    ...
    render() {
        return (
            <>
                <h3>千橡中文學校 2020-2021學年度 班級人數清單</h3>
                <br></br>
                <center>
                    <table>
                        <thead>
